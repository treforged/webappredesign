...
import { LayoutDashboard, ArrowLeftRight, Landmark, PiggyBank, Sliders, Building2, TrendingUp, LogOut, MoreHorizontal } from 'lucide-react';
    ...
    <>
      ...
      {showMore && (
        <div className="lg:hidden fixed inset-0 z-40" onClick={() => setShowMore(false)}>
          <div className="absolute bottom-16 right-4 bg-card border border-border shadow-lg p-2 space-y-1" style={{ borderRadius: 'var(--radius)' }} onClick={e => e.stopPropagation()}>
