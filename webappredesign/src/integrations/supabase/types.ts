...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      profiles: {
        Row: { auto_generate_recurring: boolean | null; budget_start_day: number | null; cash_floor: number | null; compact_mode: boolean | null; created_at: string; currency: string | null; default_deposit_account: string | null; display_name: string | null; gross_income: number | null; id: string; is_premium: boolean | null; monthly_income_default: number | null; paycheck_day: number | null; paycheck_frequency: string | null; show_cents: boolean | null; tax_rate: number | null; updated_at: string; user_id: string; weekly_gross_income: number | null }
        Insert: { auto_generate_recurring?: boolean | null; budget_start_day?: number | null; cash_floor?: number | null; compact_mode?: boolean | null; created_at?: string; currency?: string | null; default_deposit_account?: string | null; display_name?: string | null; gross_income?: number | null; id?: string; is_premium?: boolean | null; monthly_income_default?: number | null; paycheck_day?: number | null; paycheck_frequency?: string | null; show_cents?: boolean | null; tax_rate?: number | null; updated_at?: string; user_id: string; weekly_gross_income?: number | null }
        Update: { auto_generate_recurring?: boolean | null; budget_start_day?: number | null; cash_floor?: number | null; compact_mode?: boolean | null; created_at?: string; currency?: string | null; default_deposit_account?: string | null; display_name?: string | null; gross_income?: number | null; id?: string; is_premium?: boolean | null; monthly_income_default?: number | null; paycheck_day?: number | null; paycheck_frequency?: string | null; show_cents?: boolean | null; tax_rate?: number | null; updated_at?: string; user_id?: string; weekly_gross_income?: number | null }
        Relationships: []
      }
      recurring_rules: {
